            ...
            <div className="relative">
              <Listbox value={field.value} onChange={field.onChange}>
                {({ open }) => (
                  <div className="relative">
                    <ListboxButton
                      className={`relative w-full cursor-pointer rounded-md border px-3 py-2 text-left text-sm bg-white
                      ${
                        fieldState.error
                          ? "border-red-500"
                          : open
                    ...
                    <ListboxOptions className="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-sm ring-1 ring-gray-300 ring-opacity-5">
                      <ListboxOption
                        value=""
